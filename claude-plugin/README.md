...
**Connect to a running memorix-server instance.**
...
```
/v1alpha1/memorix/{tenantID}/memories/...
```
...
Replace `<PLUGIN_DIR>` with the actual absolute path (e.g. `/home/you/memorix/claude-plugin`).
